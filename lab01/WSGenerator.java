...
public class WSGenerator {
                    ...
                    if (part != null) {
                        for (int i = 0; i< count; i++){
                            if (part.equals(words[i])){
                                System.err.println("Error: The word " + part + " is repeated");
                                br.close();
                                System.exit(1);
                            }
                        }
                ...
                if (line != null) {
                    for (int i = 0; i< count; i++){
                        if (line.equals(words[i])){
                            System.err.println("Error: The word " + line + " is repeated");
                            br.close();
                            System.exit(1);
                        }
                    }
    ...
    public static void orderStrings(String[] array) {
        boolean trocado;
            ...
            if (word != null) {
                ...
                if (!coordinates.isEmpty() && !directions.isEmpty()) { //necessário definir a direção 
                    ...
                    while (!is_valid) {
                        n_atempts++;
                        if (n_atempts > 200) {
                            System.err.println("Error: It was not possible to place the word " + word);
                            System.exit(0);
                        }
